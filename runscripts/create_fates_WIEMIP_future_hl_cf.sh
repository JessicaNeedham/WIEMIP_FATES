...
export TAG='noresm-fates-f09-wiemip-future-hl-cf'
...
cp /cluster/work/projects/nn9560k/inputdata/WIEMIP/wiemip_future_hl_cf_datm.streams user_nl_datm_streams
