...
export TAG='noresm-fates-f09-wiemip-nofire-postAD-spinup'
...
./xmlchange RUN_STARTDATE=0436-01-01 # check this matches end of AD spinup run
./xmlchange CLM_ACCELERATED_SPINUP=off
./xmlchange CCSM_CO2_PPMV=280.
./xmlchange DATM_YR_START=1850
./xmlchange DATM_YR_END=1869
./xmlchange DATM_YR_ALIGN=
