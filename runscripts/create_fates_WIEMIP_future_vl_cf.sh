...
export TAG='noresm-fates-f09-wiemip-future-vl-cf'
...
cp /cluster/work/projects/nn9560k/inputdata/WIEMIP/wiemip_future_vl_cf_datm.streams user_nl_datm_streams
