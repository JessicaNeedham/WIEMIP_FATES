...
exprmts="l m ml ml-cf hl hl-cf vl vl-cf"

for exp in $exprmts; do
    

    export TAG='noresm-fates-f09-wiemip-overshoot-$exp_v2'
    ...
    cat >>  user_nl_clm <<EOF
finidat='/cluster/work/users/jessica/wiemip_misc//cluster/work/users/jessica/wiemip_runs_v2/noresm-fates-f09-wiemip-overshoot-hist_v2.2026-09-04/run/'
...
EOF
    ...
    cp /cluster/shared/noresm/inputdata/WIEMIP/wiemip_future_$exp_datm.streams user_nl_datm_streams
